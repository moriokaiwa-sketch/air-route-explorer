...
const FlightBoard = ({ airportCode, airportName, destinationFilterCode, onClose, onSelectFlight }) => {
  ...
  const filteredFlights = destinationFilterCode 
    ? flights.filter(f => f.destinationCode === destinationFilterCode)
    : flights;

  const filterDestName = destinationFilterCode 
    ? (filteredFlights[0]?.destinationName || flights.find(f => f.destinationCode === destinationFilterCode)?.destinationName || destinationFilterCode)
    : null;
